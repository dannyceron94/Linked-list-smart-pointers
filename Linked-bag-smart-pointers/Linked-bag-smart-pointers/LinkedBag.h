...
private:
	int getCurrentSize340RecursiveHelper(const std::shared_ptr<Node<ItemType>>&) const; // if needed
	int getFrequencyOf340RecursiveHelper(const std::shared_ptr<Node<ItemType>>&, const ItemType&) const; // if needed
/*----------------------------------------------------------------------*/
...
private:
	...
	std::shared_ptr<Node<ItemType>>headPtr{ nullptr };//added
